...
class DatosPersistentes:
    ...
    def _cargarCarreras(self, claveCentro: str, update: bool = False):
        ...
        rutaCarrerasCentro = os.path.join(
            self.rutaCarreras, f"{claveCentro}.dat")
        ...
        for c in carreras:
            ...
            self.carreras[claveCentro].append(
                RegistroCatalogo(clave, nombre, depto))

    def _cargarMaterias(self, claveCentro: str, update: bool = False):
        # Generamos la ruta al centro que intentamos cargar
        rutaMateriaCentro = os.path.join(
            self.rutaMaterias, f"{claveCentro}.dat")
        ...
        for m in materias:
            ...
            self.materias[claveCentro].append(
                RegistroCatalogo(clave, nombre, depto))
            ...
            try:
                ...
                for entrada in br:
                    ...
                    if not registro.departamento \
                            or not registro.nombre or not registro.clave:
                        continue
